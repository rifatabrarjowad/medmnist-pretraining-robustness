...
![Corruption-family dependence of ImageNet pretraining. Positive values indicate an advantage for ImageNet initialization; negative values favor scratch training.](../figures/figure1_family_effects.png)



**Table 3. Corruption-family effects of ImageNet initialization.**

| Dataset   | Corruption family   |   N corruptions |   Δ bACC (pp) |       Δ BE |
|:----------|:--------------------|----------------:|--------------:|-----------:|
| blood     | blur                |               2 |       6.45926 |  0.31872   |
| blood     | color               |               5 |      30.7368  |  5.53331   |
| blood     | digital             |               2 |      -7.26965 | -0.782684  |
| blood     | task_specific       |               2 |      14.0432  |  0.768877  |
| derma     | blur                |               3 |     -18.2196  | -0.289354  |
| derma     | color               |               4 |      16.2891  |  0.332809  |
| derma     | digital             |               2 |     -14.845   | -0.305213  |
| derma     | noise               |               4 |      -7.60156 | -0.0961204 |
| derma     | task_specific       |               2 |      21.1678  |  0.358742  |
| pneumonia | blur                |               1 |      -8.56923 | -0.313803  |
| pneumonia | color               |               6 |       9.57692 |  0.61337   |
| pneumonia | digital             |               2 |     -10.6906  | -0.409596  |
| pneumonia | noise               |               4 |     -21.0094  | -0.50238   |
...
![Effect of BloodMNIST training-set size on the clean balanced-accuracy advantage of ImageNet initialization.](../figures/h2_training_fraction.png)
...
![Clean balanced-accuracy gain versus corrupted balanced-accuracy gain across dataset-seed pairs.](../figures/h3_clean_vs_corrupted.png)
...
Across the 15 dataset-seed pairs, clean-accuracy gain was negatively associated with corrupted-accuracy gain (Pearson r = -0.63; Spearman $\rho$ = -0.46). Clean gain was also negatively associated with BE advantage (Pearson r = -0.79; Spearman $\rho$ = -0.63). Because these 15 observations contain repeated seeds within only three datasets, these correlations are treated as descriptive rather than as independent-sample confirmatory tests.
...
![Pretraining advantage across corruption severity by dataset and corruption family. Error bars show paired-seed bootstrap 95% confidence intervals.](../figures/figure4_severity_with_ci.png)
...
Of the four preregistered hypotheses, only H2 was supported. H1, H3, and H4 were rejected (Table 2).

**Table 2. Summary of preregistered hypotheses and outcomes.**

| Hypothesis   | Prediction                                                        | Key result                                             | Verdict   |
|:-------------|:------------------------------------------------------------------|:-------------------------------------------------------|:----------|
| H1           | Task-specific pretraining benefit smaller than noise/blur/digital | Interaction reversed: Blood +1.0009; Derma +0.5657     | Rejected  |
| H2           | Pretraining benefit increases as training data decreases          | Gap increased from +0.47 pp at 100% to +3.72 pp at 10% | Supported |
| H3           | Clean accuracy gain explains much of robustness gain              | Clean gain negatively associated with corrupted gain   | Rejected  |
| H4           | Pretraining benefit decreases monotonically with severity         | Only 2/13 family cells were monotonically decreasing   | Rejected  |

 Overall, the results show that ImageNet initialization does not produce a uniform corruption-robustness benefit in medical image classification. Its effect depends strongly on dataset, corruption family, training-set size, and corruption severity.
